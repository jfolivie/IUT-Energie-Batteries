...
\begin{itemize}
\item  une électrode de graphite de couple rédox \ce{C6}/\ce{LiC6} ;
\item une électrode d'oxyde de cobalt de couple rédox \ce{CoO2}/\ce{LiCoO2}.
\end{itemize}
...
\item non rechargeable, par opposition au terme pile.
\end{itemize}
}
...
On peut utiliser une notation intermédiaire en notant $x$ la stoechiométrie moyenne du lithium dans \ce{LiC6}, on peut aussi noter ce processus sous la forme : 
\begin{align*}
