...
\end{align*}
Le rendement de conversion de l'énergie électrique reçu en énergie chimique utile n'est pas de \SI{100}{\percent}, car une partie de l'énergie est perdue. Cette énergie peut être perdue à cause des phénomènes \textbf{dissipatifs} (chute ohmique$\ldots$ qui se traduisent par la production de chaleur = effet joule) et, sûrement dans une moindre mesure, du phénomène d'\textbf{hystérèse} (coût énergétique lié à la barrière d'activation des réactions redox dans la batterie).
}
