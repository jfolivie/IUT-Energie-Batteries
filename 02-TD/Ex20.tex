...
\solution{On sait que : \ce{Cu (s, 2) = Cu^{2+} (aq, 2) + 2e^-}. Ainsi, pour chaque mole de \ce{Cu} oxydée, on forme 2 moles d'électrons. On peut alors en déduire la quantité de charge $Q$ délivrée par l'anode : 
\begin{align*}
