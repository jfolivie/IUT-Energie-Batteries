...
\Q \label{Q:04-01} Donner les demi-équations redox associées à chacun des couples (le pH sera supposé valoir par la suite 14). En déduire l'équation de réaction.
...
Au regard des autres espèces chimiques redox, rencontrées en chimie des solutions, le lithium est un élément très réducteur.
}
