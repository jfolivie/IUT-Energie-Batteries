...
\newcommand{\backgroundbis}[5]{%
  \begin{pgfonlayer}{background2}
    ...
    \path[fill=yellow!10,rounded corners, draw=black!50, dashed]
      (a1) rectangle (a2);
    \path (a1.east |- a1.south)+(4.2,-0.0) node (u1)%[texto]
      {\scriptsize\textsc{#5}};
  \end{pgfonlayer}}
...
\newcommand{\background}[5]{%
  \begin{pgfonlayer}{background}
    ...
    \path[fill=yellow!20,rounded corners, draw=black!50, dashed]
      (a1) rectangle (a2);
    \path (a1.east |- a1.south)+(1.7,-0.1) node (u1)%[texto]
      {\scriptsize\textsc{#5}};
  \end{pgfonlayer}}
...
\path \practica {1}{Pile}{};
\path (p1.east)+(4.0,0.0) \practica{2}{Accumulateur}{};
\path (p2.east)+(4.0,-0.0) \practica{3}{Primaire}{};
\path (p3.east)+(4.0,-0.0) \practica{4}{Secondaire}{};

%\path (p2.north)+(0.0,2.5) \practica{5}{Distribution de taille}{$\bar{M}_n$, $\bar{X}_n$, $\bar{M}_w$, $\bar{I}_p$};
%\path (p5.east)+(2.5,-0.0) \practica{6}{Microstructure}{$?$};
 
%Connection
%\path [line] (p2.north) -- +(0.0,+1.0) -- +(4.0,+1.0)
%    -- node [above, midway] {} (p6) ;   
%\path [line] (p4.north) -- +(0.0,+1.0) -- +(-4.0,+1.0)
%    -- node [above, midway] {} (p6) ; 
...
%Background 
\backgroundbis{p1}{p4}{p4}{p1}{Convertisseurs d'énergie chimique en énergie électrique}
\background{p1}{p2}{p2}{p1}{Une cellule électrochimique}
\background{p3}{p4}{p4}{p3}{Plusieurs cellules}
