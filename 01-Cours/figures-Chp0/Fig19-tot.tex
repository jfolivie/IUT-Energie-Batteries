...
\path \practica {1}{Réaction de formation}{\includegraphics[scale=0.65]{Fig19a}};
\path (p1.east)+(4.0,0.0) \practica{2}{Réaction de déplacement}{\includegraphics[scale=0.65]{Fig19b}};
\path (p2.east)+(-5.0,-3.0) \practica{3}{Réaction d'insertion}{\includegraphics[scale=0.65]{Fig19c}};
 
%Background 
\backgroundbis{p1}{p2}{p2}{p3}{Type de réactions $\ldots$ dans les batteries lithium-ion}
\background{p1}{p2}{p2}{p1}{$\ldots$ de recomposition}
\background{p3}{p3}{p3}{p3}{$\ldots$ d'insertion}
