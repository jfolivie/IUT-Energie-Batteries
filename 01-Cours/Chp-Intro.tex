...
\captionof{figure}{Chronologie des technologies successives de batteries.}
\end{minipage}
...
\end{wrapfigure}
L'Histoire commence réellement en 1801, lorsque A. Volta, chercheur en physique expérimentale à l'Université de Pavie, conçu la première pile à base d'argent et de zinc. Il souhaitait démontrer que l'électricité était générée par les métaux lorsque l'on les relie à l'aide d'un buvard imbibé de saumure.
