...
\begin{center}
\includegraphics[scale=0.9]{figures-Chp0/Fig10}
\end{center}
...
Cependant, il peut exister des applications allant au délà de ces plages (\emph{par ex.} les voitures électriques nécessitent des tensions autour de \SI{200}{\volt}).
