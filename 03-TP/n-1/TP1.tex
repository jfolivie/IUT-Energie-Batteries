...
\begin{mybox}
\question[1] Superposer la caractéristique expérimentale à celle du modèle de Thévenin. En vous appuyant sur un raisonnement énergétique, commenter le résultat obtenu.
\begin{solution}[8cm]
